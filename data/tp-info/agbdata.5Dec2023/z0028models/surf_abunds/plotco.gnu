...
set label "Y=0.28" at 2.2, 2.7 font "Arial,16"
set label "Y=0.30" at 3.1, 2.3 font "Arial,16"
set label "Y=0.35" at 3.1, 1.72 font "Arial,16"
...
plot [0.8:8.2][0.:3.2] "z014.dat" using 1:3 title "Z = 0.014, Y=0.28" with lp ls 2,\
"m2z014.dat" using 1:3 notitle with lp ls 5,\
"m2.5z014.dat" using 1:3 notitle with lp ls 5,\
"m2.25z014.dat" using 1:3 notitle with lp ls 5,\
...
"y0.35.dat" using 1:2 title "Y=0.35" with l ls 5
