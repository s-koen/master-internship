...
axs[6].set_xlabel(r"Effective temperature ($T_\textrm{eff}$)")
axs[4].set_xlabel(r"Effective temperature ($T_\textrm{eff}$)")
axs[0].set_ylabel(r"Luminosity ($L_\odot$)")
axs[3].set_ylabel(r"Luminosity ($L_\odot$)")
axs[6].set_ylabel(r"Luminosity ($L_\odot$)")
axs[5].set_xlabel(r"Effective temperature ($T_\textrm{eff}$)")
plt.savefig("/home/koen/LaTeX-setup/plots/hr-overshooting.pgf", format="pgf")
plt.show()
plt.close()
# %%
