...
if __name__ == '__main__':
    ...
    mist_dir = './MIST_v1.2_feh_p0.00_afe_p0.0_vvcrit0.0_EEPS/'

    # Initial stellar mass, this has to be in the MIST collection.
    # 'Star' is an object containing the stellar model data for this mass
    mass = float(input('>> Stellar mass [Msun]: '))
    Star = read_stellar_models( [mass], mist_dir )[0]
...
#    Options.wind_model = "Saladino"  # "fast" / "BHL" / "Saladino"
    ...
    print( f'Using {Options.tide_scale_factor} times {Options.tide_model} tides with {Options.tidal_freq_scaling} scaling, capped at {Options.tide_max_fconv}' )
